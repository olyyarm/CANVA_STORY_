...
- в ноде «Таймлайн»: `Ассеты → Comfy API · GPT Image 2 Low`, чтобы команда «Добрать недостающее» использовала API для персонажей, общих локаций и недостающих фонов сцен;
