...
const createNarration = (sceneCount: number) =>
  Array.from({ length: sceneCount }, (_, index) =>
    [
      `Сцена ${index + 1}:`,
      index === 0
        ? 'Он очнулся на холодном полу чужого дома и понял, что не помнит ни этого места, ни людей вокруг. Хозяин потребовал объяснений, но герой сначала проверил, может ли встать, и заметил на столе письмо со своим именем. Именно оно стало первой ниткой, за которую можно было ухватиться.'
        : 'Письмо привело его в городскую мастерскую, где работник уже собирался потерять дневной заработок из-за порванного кармана. Герой попросил повторить обычное движение с инструментом и увидел, как ткань снова лопнула в одном и том же углу. Теперь у него было не готовое решение, а первое доказательство того, где искать причину.',
    ].join('\n'),
  ).join('\n');
...
const createChapterPlan = () => JSON.stringify({
  schema_version: 1,
  arc_title: 'Цена удобства',
  arc_promise: 'Маленькое техническое решение постепенно становится конфликтом с устройством мира.',
  recommended_chapter_count: 3,
  count_reason: 'Трёх глав достаточно для проверки полного локального сценария без платных генераций.',
  global_causal_chain: [
    'Ремонт спасает заработок работника и привлекает внимание цеха.',
    'Проверка цеха превращает частный ремонт в публичный спор.',
    'Победа создаёт политический долг и новую угрозу.',
  ],
  chapters: [
    {
      number: 1,
      title: 'Рваный карман',
      human_problem: 'Работник рискует заработком из-за неудобной одежды.',
      professional_problem: 'Нагрузка сосредоточена в одном углу кармана.',
      turning_point: 'Героиня доказывает причину разрыва повторяемой проверкой.',
      final_state: 'Карман усилен, но мастер цеха замечает нарушение правил.',
      immediate_consequence: 'Мастер требует публичного испытания ремонта.',
      next_action: 'Подготовить изделие к проверке цеха.',
      scene_count: 6,
    },
    {
      number: 2,
      title: 'Испытание цеха',
      human_problem: 'Работник боится потерять место из-за помощи героини.',
      professional_problem: 'Ремонт должен выдержать реальное движение и вес инструмента.',
      turning_point: 'Изделие выдерживает проверку, а старый образец рвётся.',
      final_state: 'Цех не может отрицать результат и объявляет ремонт опасным прецедентом.',
      immediate_consequence: 'Другие работники тайно приносят героине свои вещи.',
      next_action: 'Решить, кому помочь первым, не вызвав открытую расправу.',
      scene_count: 7,
    },
    {
      number: 3,
      title: 'Очередь у двери',
      human_problem: 'Просьбы работников сталкиваются с угрозой наказания.',
      professional_problem: 'Нужно превратить единичный ремонт в повторяемый способ усиления.',
      turning_point: 'Героиня создаёт простой шаблон и обучает первого помощника.',
      final_state: 'Решение начинает распространяться без разрешения цеха.',
      immediate_consequence: 'Цех закрывает мастерские и ищет источник новых ремонтов.',
      next_action: 'Сохранить шаблон и защитить помощника.',
      scene_count: 8,
    },
  ],
}, null, 2);
