...
export const buildSceneShotGridPrompt = ({
  ...
  'Fill all four quadrants edge-to-edge. No outer margins, gutters, borders, black title strips, captions, panel labels, shot names, shot numbers, subtitles, logos, or watermarks.',
  'IMPORTANT: the quadrant descriptions below are production instructions only. Never print, typeset, caption, or otherwise visualize their wording inside the contact sheet. In particular, do not write LOCATION ESTABLISHING SHOT, LOCATION ATMOSPHERE INSERT, CHARACTER IN CONTEXT, CHARACTER EMOTION, or translated equivalents anywhere in the image.',
  ...
  '',
  'Quadrants, in reading order from top-left to bottom-right. These are invisible production directions, not titles:',
  'For the top-left quadrant, create an extreme-wide or wide master shot that clearly explains what kind of place this is, its scale, architecture, foreground, middle ground, background, entrances, exits, and the character position. The character is small and is not the visual subject.',
  'For the top-right quadrant, create a low, high, or close environmental cutaway with no character as the subject. Show material, age, weather, decay, light, sound-implied detail, or a small diegetic micro-detail supported by the narration and mood. For example, a rat near a puddle is acceptable only if the described place genuinely supports damp basement decay. Never turn this detail into a new clue or event.',
  'For the bottom-left quadrant, create a medium-wide or full-body shot showing the character posture, physical state, and current action inside the established space. This composition must not resemble the top row.',
  'For the bottom-right quadrant, create a close-up or medium close-up of the face, gaze, breathing, or a narration-relevant physical reaction. If a face close-up is unsuitable, use a first-person or over-the-shoulder view. Do not repeat a hand close-up or the composition of any other quadrant.',
  '',
  'Before rendering, silently audit the sheet: two location-led panels, two character-led panels, four different shot scales and camera positions, no duplicated composition, no invented handheld object, and absolutely no editorial text naming or explaining any quadrant.',
  '',
  `Scene: ${sceneLabel}`,
  `Scene description:\n${sceneText.trim()}`,
